classdef RMTF6_3 < PROBLEM
% <multi/many> <real> <large/none>
% The neural network training problem
% nHidden1 --- 14 --- Size of the first hidden layer
% nHidden2 --- 7 --- Size of the second hidden layer
...
% Statlog_German                     1000      24       2
    ...
    methods
        ...
        function Setting(obj)
            [obj.nHidden1,obj.nHidden2] = obj.ParameterSet(14,7);
			% Load data
            Data  = load('Dataset\DryBeanSekerBombay.txt');
