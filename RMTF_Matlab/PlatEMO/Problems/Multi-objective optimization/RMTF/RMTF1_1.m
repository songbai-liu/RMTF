    ...
    methods
        ...
        function PopObj = CalObj(obj,PopDec)
            ...
            for i = 1 : size(PopDec,1)
                ...
                Z  = Predict(obj.TrainIn,W1,W2,W3);%Gaussian activation
...
function [Z,Y1,Y2] = Predict(X,W1,W2,W3)
	Y1 = exp(-([ones(size(X,1),1),X]*W1).^2);%Gaussian
    Y2 = exp(-([ones(size(Y1,1),1),Y1]*W2).^2);%Gaussian
