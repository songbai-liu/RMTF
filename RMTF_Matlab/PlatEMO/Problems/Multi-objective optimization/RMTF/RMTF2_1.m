classdef RMTF2_1 < PROBLEM
% <multi/many> <real> <large/none>
% The neural network training problem
% nHidden1 --- 50 --- Size of the first hidden layer
% nHidden2 --- 20 --- Size of the second hidden layer
...
% Connectionist_bench_Sonar           208      60       2
    ...
    methods
        ...
        function Setting(obj)
            [obj.nHidden1,obj.nHidden2] = obj.ParameterSet(50,20);
			% Load data
            Data  = load('Dataset\RaisinGrains.txt');
