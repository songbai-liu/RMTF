...
public class MMZDT extends Problem {
	...
	double evalG(double[] xII) throws JMException {
		...
		else if (gType_.equalsIgnoreCase("F171"))
			return GFunctions.getF171(xII, shiftValues_, rotationMatrix_);
		else if (gType_.equalsIgnoreCase("F172"))
			return GFunctions.getF172(xII, shiftValues_, rotationMatrix_);
		else if (gType_.equalsIgnoreCase("F173"))
			return GFunctions.getF173(xII, shiftValues_, rotationMatrix_);
		else if (gType_.equalsIgnoreCase("F174"))
			return GFunctions.getF174(xII, shiftValues_, rotationMatrix_);
		else if (gType_.equalsIgnoreCase("F175"))
			return GFunctions.getF175(xII, shiftValues_, rotationMatrix_);
		else if (gType_.equalsIgnoreCase("F176"))
			return GFunctions.getF176(xII, shiftValues_, rotationMatrix_);
		else if (gType_.equalsIgnoreCase("FM1"))
			return GFunctions.getFM1(xII, shiftValues_, rotationMatrix_);
		else if (gType_.equalsIgnoreCase("FM2"))
			return GFunctions.getFM2(xII, shiftValues_, rotationMatrix_);
		else if (gType_.equalsIgnoreCase("FM3"))
			return GFunctions.getFM3(xII, shiftValues_, rotationMatrix_);
		else if (gType_.equalsIgnoreCase("FM4"))
			return GFunctions.getFM4(xII, shiftValues_, rotationMatrix_);
		else if (gType_.equalsIgnoreCase("FM5"))
			return GFunctions.getFM5(xII, shiftValues_, rotationMatrix_);
		else if (gType_.equalsIgnoreCase("FM6"))
			return GFunctions.getFM6(xII, shiftValues_, rotationMatrix_);
		else {
