...
import etmo.problems.Benchmarks_RMTF.RMTF1;
import etmo.problems.Benchmarks_RMTF.RMTF2;
import etmo.problems.Benchmarks_RMTF.RMTF3;
import etmo.problems.Benchmarks_RMTF.RMTF4;
import etmo.problems.Benchmarks_RMTF.RMTF5;
import etmo.problems.Benchmarks_RMTF.RMTF6;
import etmo.problems.Benchmarks_RMTF.RMTF7;
			...
			for (int t = 1; t <= times; t++) {	
				...
				for(int i=0;i<taskNumber;i++){
					if(resPopulation[i].size()==0)
						continue;
					resPopulation[i].printObjectivesToFile("EMTET_"+problemSet.get(i).getNumberOfObjectives()+"Obj_"+
