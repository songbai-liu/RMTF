	    	...
	    	for(int i=0;i<taskSize;i++){
				...
				for(int a=1;a<=3;a++) {
					for(int t=0;t<runtimes;t++) {
						String path = "D:\\ResearchWork\\2021\\2021_P6_ETDAE\\Review1\\RMTF\\FE50";
						...
						WFG = new wfghvCalculator(population,1,numObj);
						hvArray[t] = WFG.calculatewfghv();
					}//for times
					
					printGD(algorithms[a]+"_"+numObj+"Obj_"+problemSet.get(i).getName()+ "_" + numVar + "D_HV.txt",hvArray);
					double sumHV = 0;
					for(int t=0;t<runtimes;t++){
					  sumHV+=hvArray[t];
					}
